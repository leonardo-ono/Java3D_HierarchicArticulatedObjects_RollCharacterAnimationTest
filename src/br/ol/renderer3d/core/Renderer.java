...
import br.ol.renderer3d.buffer.ColorBuffer;
import br.ol.renderer3d.buffer.DepthBuffer;
import br.ol.renderer3d.rasterizer.TriangleRasterizer;
...
//        if ((v1.p.x / v1.p.w < -400 && v2.p.x / v2.p.w < -400 && v3.p.x / v3.p.w < -400)
//                || (v1.p.x / v1.p.w > 400 && v2.p.x / v2.p.w > 400 && v3.p.x / v3.p.w > 400)
//                || (v1.p.y / v1.p.w < -300 && v2.p.y / v2.p.w < -300 && v3.p.y / v3.p.w < -300)
//                || (v1.p.y / v1.p.w > 300 && v2.p.y / v2.p.w > 300 && v3.p.y / v3.p.w > 300)
//                || (v1.p.z > -1 && v2.p.z > -1 && v3.p.z > -1)) {
//            return;
//        }
